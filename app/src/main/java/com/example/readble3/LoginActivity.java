...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginNowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mobileTxt.isEmpty() || passwordTxt.isEmpty()) {
                    Toast.makeText(LoginActivity.this, "Please enter mobile or password", Toast.LENGTH_SHORT).show();
                } else {
        ...
        registerNowTV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivity.this, RegisterActivity.class)); // open Register activity
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.child("users").hasChild(mobileNumber)) {
                    Toast.makeText(LoginActivity.this, "Mobile number is not exists in the database", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (password != null) {
                        ...
                        if (password.equals(userEnteredPassword)) {
                            ...
                            MemoryData.saveMobile(mobileNumber, LoginActivity.this);
                        ...
                        Toast.makeText(LoginActivity.this, "Unable to get user's password from the database", Toast.LENGTH_SHORT).show();
                    }
                }
            }
