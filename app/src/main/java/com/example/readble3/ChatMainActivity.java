...
import com.example.readble3.messages.MessagesAdapter;
import com.example.readble3.messages.MessagesList;
...
public class ChatMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagesAdapter = new MessagesAdapter(userMessagesList, ChatMainActivity.this);
                    ...
                    if (getMobile != null) {
                        ...
                        if (!getMobile.equals(mobileNumber)) {
                            ...
                            if (!chatKey[0].isEmpty()) {
                                ...
                                final long userLastSeenMessage = Long.parseLong(MemoryData.getLastMsgTS(ChatMainActivity.this, chatKey[0]));
